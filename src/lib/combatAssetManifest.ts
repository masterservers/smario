...
export const PLANNED_COMBAT_ASSETS: PlannedCombatAsset[] = [
  ...
  A({
    ...
    kind: "kick",
    tier: 4,
    mappedMoveIds: ["w-running-knee-strike", "w-bicycle-knee-strike", "w-jumping-knee-strike"],
    attackerStartState: "neutral-standing",
    attackerEndState: "close-standing",
  ...
  A({
    ...
    kind: "kick",
    tier: 4,
    mappedMoveIds: ["w-superkick", "high-kick"],
    attackerStartState: "close-standing",
    attackerEndState: "neutral-standing",
    defenderStartState: "close-standing",
    defenderEndState: "grounded-face-up",
  ...
  A({
    ...
    kind: "punch",
    tier: 3,
    mappedMoveIds: ["corner-combo", "w-corner-clothesline", "corner-ne-hooks"],
    attackerStartState: "close-standing",
    attackerEndState: "close-standing",
  ...
  A({
    ...
    kind: "throw",
    tier: 3,
    mappedMoveIds: ["w-belly-to-belly-suplex", "w-overhead-belly-to-belly-suplex"],
    attackerStartState: "clinched",
    attackerEndState: "neutral-standing",
    defenderStartState: "clinched",
    defenderEndState: "grounded-face-up",
  ...
  A({
    ...
    kind: "throw",
    tier: 4,
    mappedMoveIds: ["fireman-carry", "w-fireman-s-carry-slam", "w-fallaway-slam"],
    attackerStartState: "clinched",
    attackerEndState: "neutral-standing",
    defenderStartState: "clinched",
    defenderEndState: "grounded-face-up",
  ...
  A({
    ...
    kind: "aerial",
    tier: 5,
    mappedMoveIds: ["w-frog-splash", "w-diving-splash", "top-rope-splash"],
  ...
  A({
    ...
    kind: "aerial",
    tier: 4,
    mappedMoveIds: ["w-crossbody", "w-diving-crossbody", "w-flying-clothesline"],
    attackerStartState: "ropes",
    attackerEndState: "grounded-face-down",
    defenderStartState: "neutral-standing",
    defenderEndState: "grounded-face-up",
  ...
  A({
    ...
    kind: "aerial",
    tier: 4,
    mappedMoveIds: ["w-diving-elbow-drop", "r-flying-elbow"],
    attackerStartState: "ropes",
    attackerEndState: "kneeling",
    defenderStartState: "grounded-face-up",
    defenderEndState: "grounded-face-up",
  ...
  A({
    ...
    kind: "aerial",
    tier: 4,
    mappedMoveIds: ["w-springboard-moonsault", "w-springboard-crossbody", "r-springboard"],
    attackerStartState: "neutral-standing",
    attackerEndState: "kneeling",
    defenderStartState: "neutral-standing",
    defenderEndState: "grounded-face-up",
  ...
  A({
    ...
    kind: "grapple",
    tier: 3,
    mappedMoveIds: ["w-elbow-drop", "v-mat-elbows"],
    attackerStartState: "neutral-standing",
    attackerEndState: "kneeling",
    defenderStartState: "grounded-face-up",
    defenderEndState: "grounded-face-up",
