...
const FAMILY_PATTERNS: Record<Exclude<SceneFamily, "other">, RegExp> = {
  punch: /JAB|HOOK|CROSS|UPPERCUT|SHOT|COMBO|COMBINATION|ELBOW|SLAP|BACKFIST|PUNCH|COUNTER|CHOP|LARIAT|FOREARM|HEADBUTT|RAINMAKER|HIDDEN BLADE/,
  kick: /KICK|TEEP|SPIN|CLOTHESLINE|SHOULDER|CHARGE|RUSH|STOMP|WIZARD|KINSHASA|CHIN MUSIC/,
  rope: /ROPE|TURNBUCKLE|CLIMB|VAULT|SPRINGBOARD|LEAP|JUMP|DIVE|SOMERSAULT|MOONSAULT|SPLASH|SENTON|PLANCHA|TOPE|CROSSBODY|SWANTON|450|SHOOTING STAR|CORKSCREW|COUP DE GRACE|PHENOMENAL|DOOMSDAY/,
  throw: /SLAM|THROW|TOSS|SUPLEX|POWERBOMB|CARRY|SPINEBUSTER|TAKEDOWN|BOMB|WHIP|DRAG|DDT|DRIVER|BUSTER|CUTTER|STUNNER|RKO|NECKBREAKER|BACKBREAKER|CHOKESLAM|URANAGE|PILEDRIVER|PEDIGREE|FALCON ARROW|JACKHAMMER|BURNING HAMMER|STYLES CLASH|DESTROYER|SPEAR|GORE|SNAPMARE|RANA|FRANKENSTEINER|ANGEL|GTS|F-5|3D/,
  mat: /MAT|GROUND|STOMP|DROP|MOUNT|PIN|DOWN|CRAWL|RISE|CRADLE|SMALL PACKAGE|ROLL-UP|MAGISTRAL|BACKSLIDE|SUNSET FLIP|VICTORY ROLL|BRIDGE|CRUCIFIX|SCHOOLBOY|CURB/,
  clinch: /CLINCH|GRAPPLE|KNEE|LOCK|HOLD|COLLAR|PUSH|SHOVE|CORNER|CRAB|CLUTCH|CHOKE|SLEEPER|ARMBAR|KIMURA|CROSSFACE|STF|STS|NELSON|STRETCH|OCTOPUS|CLAW|HEADLOCK|FACELOCK|TIE-UP|TEST OF STRENGTH|CHICKENWING|CLOVERLEAF|WALLS OF|HEEL HOOK|BEAR HUG/,
...
const FAMILY_RULES: Array<[SceneFamily, RegExp]> = [
  ["rope", /ROPE|TURNBUCKLE|CLIMB|VAULT|SPRINGBOARD|LEAP|JUMP|DIVE|SOMERSAULT|MOONSAULT|SPLASH|CORNER CLIMB|SENTON|PLANCHA|TOPE|CROSSBODY|SWANTON|450|SHOOTING STAR|CORKSCREW|COUP DE GRACE|PHENOMENAL|DOOMSDAY/],
  ["throw", /SLAM|THROW|TOSS|SUPLEX|POWERBOMB|CARRY|SPINEBUSTER|TAKEDOWN|BOMB|WHIP|DDT|DRIVER|BUSTER|CUTTER|STUNNER|RKO|NECKBREAKER|BACKBREAKER|CHOKESLAM|URANAGE|PILEDRIVER|PEDIGREE|FALCON ARROW|JACKHAMMER|BURNING HAMMER|STYLES CLASH|DESTROYER|SPEAR|GORE|SNAPMARE|RANA|FRANKENSTEINER|ANGEL|GTS|F-5|3D/],
  ["mat", /MAT|GROUND|STOMP|DROP|MOUNT|PIN|DOWN|CRAWL|RISE|GET UP|CRADLE|SMALL PACKAGE|ROLL-UP|MAGISTRAL|BACKSLIDE|SUNSET FLIP|VICTORY ROLL|BRIDGE|CRUCIFIX|SCHOOLBOY|CURB/],
  ["clinch", /CLINCH|GRAPPLE|KNEE|LOCK|HOLD|COLLAR|PUSH|SHOVE|CRAB|CLUTCH|CHOKE|SLEEPER|ARMBAR|KIMURA|CROSSFACE|STF|STS|NELSON|STRETCH|OCTOPUS|CLAW|HEADLOCK|FACELOCK|TIE-UP|TEST OF STRENGTH|CHICKENWING|CLOVERLEAF|WALLS OF|HEEL HOOK|BEAR HUG/],
  ["kick", /KICK|TEEP|SPIN|CLOTHESLINE|SHOULDER|CHARGE|RUSH|WIZARD|KINSHASA|CHIN MUSIC/],
  ["punch", /JAB|HOOK|CROSS|UPPERCUT|SHOT|COMBO|COMBINATION|ELBOW|SLAP|BACKFIST|PUNCH|COUNTER|CHOP|LARIAT|FOREARM|HEADBUTT|RAINMAKER|HIDDEN BLADE/],
  ["taunt", /LOOK|STARE|CIRCL|BREATH|POSE|TAUNT|WAIT|GUARD|FEEL|WALK|PACE/],
];
